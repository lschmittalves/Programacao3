...
public class PIDController {
    ...
    private void calculate() {
        ...
        if (m_enabled) {
            ...
            m_error = m_setpoint - getM_input();

                        // !!!!DEBUG!!!
             System.out.println(getM_input());
     ...
     * @return the m_input
     */
    public double getM_input() {
        return m_input;
    }

    /**
     * @param m_input the m_input to set
     */
    public void setM_input(double m_input) {
